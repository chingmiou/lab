...
namespace CSharpAdvanceDesignTests
{
    ...
    public class JoeyWhereTests
    {
        ...
        private IEnumerable<int> JoeyGroupSum(IEnumerable<Product> products, int groupSize, Func<Product, int> selector)
        {
...
//                new Product {Id = 2, Cost = 21, Price = 210, Supplier = "Yahoo"},
        ...
        public void where_then_select()
        {
            ...
            var actual = products
                ...
                .JoeyWhere(p => p.Cost > 30)
                .JoeySelect(p => p.Price);

            foreach (var price in actual)
            {
        ...
        {
            var names = new List<string> { "Joey", "Cash", "William", "Sam", "Brian", "Jessica" };
            var actual = Lab.MyOwnLinq.JoeyWhere(names, (name, index) => index % 2 == 0);
            var expected = new[]
            {
                "Joey", "William", "Brian"
            };
